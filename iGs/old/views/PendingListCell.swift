...
class PendingListCell: UICollectionViewCell {
    ...
    lazy var table: UITableView = {
        ...
        v.register(PendingItemCell.self, forCellReuseIdentifier: CELLID)
        v.dataSource = self
        v.delegate = self
...
extension PendingListCell : UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return items.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: CELLID, for: indexPath) as! PendingItemCell
...
class PendingItemCell : UITableViewCell {
    ...
    var detail: PendingDetailView = {
        let v = PendingDetailView()
        v.translatesAutoresizingMaskIntoConstraints = false
        return v
    }()
}
